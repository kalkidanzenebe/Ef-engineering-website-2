      ...
      <div className="relative container mx-auto px-0 md:px-4">
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="bg-orange-500 px-6 md:px-12 py-12 md:py-16 text-white">
            ...
            <a href="/contact" className="inline-flex items-center gap-3 bg-black/90 hover:bg-black text-white px-6 py-4 uppercase font-semibold tracking-wide">
              Free Quote
              <span>→</span>
            </a>
          </div>
          ...
          <div className="relative min-h-[340px] md:min-h-[460px]">
            ...
            <img src="/images/hero/house.jpg" alt="contact visual" className="absolute inset-0 w-full h-full object-cover" />
          </div>
        </div>
      </div>
    </section>
